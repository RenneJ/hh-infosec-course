...
1. Data tampering (partial or complete eradication). The chance of this happening is not zero. Therefore this is the highest risk as the impact would quite possibly mean the end for the company. A threat actor would have to use many kinds of attacks to achieve this. **The cost is equal to the worth of the company.**
...
3. Fraudulent orders. If done by repudiation and abusing/circumventing TC app payment then **3% chance * 30€ (avg. cost of ride) = 0.9€ per occurrence**. If done via spoofing using a stolen credit card or phone with access to TC customer's app then **3% chance * 30€ * 50% (chance the customer notices in time to contact TC or credit company) = 0.45€ per occurrence**. It is worth noting that the reputation damage especially in the eyes of drivers elevates the risk. How many times would you suffer to be mugged for 30€ for the incompetence of your business partner before you would find a new a partner?
