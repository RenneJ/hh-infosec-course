...
I wrote a short hard-coded program to help me solve this. It's provided in the repository main branch ([h4_code.py](https://github.com/RenneJ/hh-infosec-course/blob/main/h4_code.py)).
